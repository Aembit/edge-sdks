...
- **Strict Internal Lockfiles**: Commited lockfiles (`package-lock.json` and `uv.lock`) guarantee secure and reproducible environments for internal development and CI testing.
