...
## 3. Copying your Edge SDK Client ID
...
- Copy the full ARN string (e.g. `aembit:aembit:<tenant-id>:identity:aws_metadata:<provider-external-id>`). This will be passed as the `client_id` in your configuration.

---

## 4. Running the Example on your EC2 Instance
